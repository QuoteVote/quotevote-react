...
export default function MessageContainer(props){
  ...
  let messageData=[{Content:"src/hhsbComponents/MessageContainer.js",Color:"green",Username:"steve"},{Content:"well I say this other thing",Color:"red",Username:"alice"},{Content:"I sadi it much louder",Color:"red",Username:"bolb"}]
  return(
